...
const { insertUser, updateWeight, updateHeight, updateAge, updateEmail, updatePassword, updateUsername, updateGoal, db, getIndexValue, printDataTable } = require('./index.js');
